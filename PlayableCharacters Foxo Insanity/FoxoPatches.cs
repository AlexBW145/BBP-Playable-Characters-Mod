...
class FoxoCharacterPatches
{
    ...
    {
        if (___tutorialMode || __instance is WrathFoxo 
            || (Chainloader.PluginInfos.ContainsKey("alexbw145.baldiplus.teacherapi") && FoxoTeacherAPIManualPatches.IsTeacher(__instance))) return;
